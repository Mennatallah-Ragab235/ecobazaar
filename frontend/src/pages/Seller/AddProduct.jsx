...
// دالة مساعدة تحوّل file لـ base64
...
const handleLogout = () => {
  ...
  <div
    ...
    onClick={() => item.path && navigate(item.path)}  // ← ضيف onClick
        ...
        <main className="ap-main">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="ap-form-card">
              ...
              <div className="ap-form-group">
                <label className="ap-label">اسم المتجر <span className="ap-required">*</span></label>
                <input className="ap-input" name="storeName" value={form.storeName} onChange={handleChange}required />
              </div>
